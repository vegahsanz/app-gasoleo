...
// GUARDAR VIAJE
// =========================
const bloqueFechaViaje =
    document.getElementById("bloqueFechaViaje");
    ...
    .forEach(function (checkbox) {
        ...
        checkbox.addEventListener(
            ...
            function () {
                ...
                const usuariosSeleccionados =
                    Array.from(
                        document.querySelectorAll(
                            '#usuariosViaje input[type="checkbox"]:checked'
                        )
                    ).map(function (input) {
                        return input.value;
                    });
                ...
                if (
                    usuariosSeleccionados.includes("Olvidón")
                ) {
                    bloqueFechaViaje.style.display =
                        "block";
                } else {
                    bloqueFechaViaje.style.display =
                        "none";
