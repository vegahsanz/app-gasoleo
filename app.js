...
const fechaRepostaje = document.getElementById("fechaRepostaje");
function ponerFechaHoyRepostaje() {
...
const notaViaje =
    document.getElementById("notaViaje");
...
if (
    ...
    document.getElementById("resultado").textContent =
        "Debes indicar la fecha del viaje de Olvidón.";
...
if (usuarios.length === 0) {
    ...
    const viaje = {
        ...
        nota: notaViaje.value.trim() || null
    };
...
function rellenarKmInicial() {
    ...
    if (viajes.length > 0) {
        ...
        if (kmFinalInput.value === "") {

            const kmTexto =
                String(ultimoViaje.kmFinal);
...
function mostrarViajes() {
    ...
    botonNota.textContent = "📝";

    botonNota.addEventListener(
        "click",
        function () {

            let notaVisible =
                nuevoViaje.querySelector(
                    ".notaViajeVisible"
                );
            ...
            notaVisible.className =
                "notaViajeVisible";

            notaVisible.textContent =
                viaje.nota;

            nuevoViaje.appendChild(
                notaVisible
            );
        }
    );

    accionesViaje.appendChild(
        botonNota
    );
}
...
botonUsuarios.textContent =
    "Reparto por usuario ▼";

botonUsuarios.className =
    "botonDesplegableUsuarios";
...
contenidoResumenCiclo.appendChild(
    ...
    botonUsuarios.addEventListener(
    "click",
    function () {
    ...
    textoPagos;
        ...
        botonVer.addEventListener("click",function () {
                ...
                mostrarResumenCiclo(ciclo);
                 ...
                 if (ciclo.estado === "pendiente") {
                mostrarPendientesDelCiclo(ciclo);
                }
